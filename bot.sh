...
yellow='\033[33;1m'
clear
toilet -f standard "•AcidClown" -F gay
echo
echo $green"=========================================="
echo $red"DoS AND DDoS ATTACK LAUCH VIA TOOL By AcidClown"
echo $green"=========================================="
echo $blue   "             *********
           *************
          *****     *****
...
echo $green"============================================="
echo $white "╭─"$yellow"choose your attack"
read -p " ╰─> " pil
